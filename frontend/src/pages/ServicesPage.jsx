...
export default function ServicesPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      showToast(error.response?.data?.message || "Could not save service", "error");
    } finally {
      setLoading(false);
    }
  };
  ...
  const executeDelete = async () => {
    ...
    try {
      ...
      showToast(error.response?.data?.message || "Could not delete service", "error");
    } finally {
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="p-6">
              ...
              <p className="text-slate-500 text-sm leading-relaxed mb-6">
                ...
                Existing bookings will remain, but customers will no longer be able to book this service. This action cannot be undone.
              </p>
