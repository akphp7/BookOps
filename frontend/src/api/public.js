...
export const requestPublicBookingOtp = (slug, customerEmail) => client.post(`/public/${slug}/request-otp`, { customerEmail });
...
export const cancelPublicBookingPayment = (bookingId) => client.post('/public/booking/cancel-payment', { booking_id: bookingId });
