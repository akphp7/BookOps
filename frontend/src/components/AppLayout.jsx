          ...
          <div className={s.rightSection}>
            ...
            >
              ...
              {mobileMenuOpen ? (
                ...
                <Menu className={s.mobileMenuIcon} aria-hidden="true" />
              )}
            </button>
          </div>
        </div>
        ...
        <div className={s.footerCard}>
          ...
          <div className={s.footerBottom}>
            <div className={s.footerLegalGroup}>
              <span className={s.footerCopyright}>© 2026 BookMe. All rights reserved.</span>
            ...
            <div className={s.footerCreditWrapper}>
              ...
              >
                <img src={hexagonLogo} alt="Hexagon" className={s.footerCreditLogo} />
                <span className={s.footerCreditText}>
                  A <span className={s.footerCreditName}>Hexagon Digital Services</span> product
                </span>
              </a>
            </div>
          </div>
